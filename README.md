...
[![Version](https://img.shields.io/badge/version-3.0.7-5b5bf6?style=flat-square)](https://github.com/paulfxyz/junk/releases)
...
1. Download **`Junk_3.0.7_universal.dmg`** from [Releases](https://github.com/paulfxyz/junk/releases)
...
1. Download **`Junk_3.0.7_x64-setup.exe`** from [Releases](https://github.com/paulfxyz/junk/releases)
...
```
msiexec /i Junk_3.0.7_x64_en-US.msi /quiet
```
...
```sh
wget https://github.com/paulfxyz/junk/releases/latest/download/Junk_3.0.7_amd64.AppImage
chmod +x Junk_3.0.7_amd64.AppImage
./Junk_3.0.7_amd64.AppImage
```
...
```sh
wget https://github.com/paulfxyz/junk/releases/latest/download/Junk_3.0.7_amd64.deb
sudo dpkg -i Junk_3.0.7_amd64.deb
junk
```
...
| Runner | Artifacts |
|---|---|
| macOS | `Junk_3.0.7_universal.dmg` |
| Windows | `Junk_3.0.7_x64-setup.exe` + `Junk_3.0.7_x64_en-US.msi` |
| Ubuntu | `Junk_3.0.7_amd64.AppImage` + `Junk_3.0.7_amd64.deb` |
